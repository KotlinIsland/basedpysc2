...
The easiest way to get basedpysc2 is to use uv:

```shell
uv add basedpysc2
```

That will install the `basedpysc2` package along with all the required dependencies.

uv will install a few of the binaries to your bin directory. `pysc2_play` can
...
```shell
uv add git+https://github.com/KotlinIsland/basedpysc2
```

or from a local clone of the git repo:

```shell
git clone https://github.com/KotlinIsland/basedpysc2.git
uv add basedpysc2/
```
